...
<body>
    ...
    <section class="w3l-hotair-form">
                ...
                <div class="main-hotair">
                    <div class="content-wthree">
                        ...
                        <form action="logcheck.php" method="post">
                            <input type="text" class="text" name="username" placeholder="User Name Or Email Id" required="" autofocus>
                            <input type="password" class="password" name="password" placeholder="User Password" required="" autofocus>
                            <button class="btn" type="submit">Log In</button>
                        </form>
                        
                        <p class="account">Don't have an account? <a href="customer_details_form.php">Register</a></p>
						 <p class="account"><a href="forgot.php">Forgot Password</a></p>
                    </div>
        ...
        <div class="copyright text-center">
            <p class="copy-footer-29">© 2022-23 SWEET CORN | Design by <a
                        href="#">MALTESH</a></p>
        </div>
        <!-- //copyright-->
    </section>
