...
<body>
    ...
    <section class="w3l-hotair-form">
            ...
            <div class="workinghny-form-grid">
                <div class="main-hotair">
                    <div class="content-wthree">
                       ...
                       <h4> Name: Mahima Bhat and Ashwini Adkepal </h4>
					   <h4> 9483644749, 8762946136</h4> <hr>
					   <h4> milkmanagement@gmail.com</h4> <hr>
        ...
        <div class="copyright text-center">
            <p class="copy-footer-29">© 2022-23 JSS COLLEGE STUDENT by: Mahima Bhat and Ashwini Adkepal.  <a
                        href="#"> </a></p>
        </div>
        <!-- //copyright-->
    </section>
