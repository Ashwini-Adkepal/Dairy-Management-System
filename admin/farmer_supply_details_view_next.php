<?php include('meta_tag.php'); ?>
 ...
 <?php include('top_bar.php'); ?>
  ...
  $tot=0;
  $date=$_POST['date'];
  $sql="select * from farmer_supply_details vs,farmer_details vd,product_catalog pc where vs.farmer_id=vd.farmer_id and vs.product_id=pc.product_id and vs.supply_date='$date'";
